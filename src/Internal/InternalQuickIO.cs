...
namespace SchwabenCode.QuickIO.Internal
{
    ...
    internal static class InternalQuickIO
    {
        ...
        {
            var allFilePaths = EnumerateFilePaths( directoryPath, QuickIOPatternConstants.All, recursive ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly );
        ...
        public static void DeleteDirectory( QuickIODirectoryInfo directoryInfo, bool recursive = false )
        {
            ...
            {
                // search all contents
                var subFiles = QuickIODirectory.EnumerateFilePaths( directoryInfo.FullNameUnc, QuickIOPatternConstants.All, SearchOption.TopDirectoryOnly, QuickIOPathType.UNC );
                ...
                var subDirs = QuickIODirectory.EnumerateDirectories( directoryInfo);
        ...
        public static int GetShareEnumResult(string machineName, QuickIOShareApiReadLevel level, out IntPtr buffer, out int entriesRead, out int totalEntries, ref int resumeHandle)
        {
