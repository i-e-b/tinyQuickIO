    ...
    public static partial class QuickIOShare
    {
        ...
        public static IEnumerable<QuickIOShareInfo> EnumerateShares( String machineName = null, QuickIOShareApiReadLevel level = QuickIOShareApiReadLevel.Admin )
        {
            ...
            try
            {
                ...
                var returnCode = InternalQuickIO.GetShareEnumResult(targetName, level, out buffer, out entriesRead, out totalEntries, ref resumeHandle);
                ...
                if ( returnCode == Win32ErrorCodes.ERROR_ACCESS_DENIED ) // Access Denied
                {
                    ...
                    returnCode = InternalQuickIO.GetShareEnumResult(targetName, level, out buffer, out entriesRead, out totalEntries, ref resumeHandle);
                }
